...
impl<T: Copy> TrieST<T> {
	...
	pub fn longest_key_of_prefix(&self, prefix: &str) -> Option<String> {
...
mod tests {
	...
	fn longest_key_of_prefix() {
		...
		assert_eq!(None, t.longest_key_of_prefix(""));
		assert_eq!(None, t.longest_key_of_prefix("a"));
		assert_eq!(Some(String::from("are")), t.longest_key_of_prefix("are"));

		assert_eq!(None, t.longest_key_of_prefix("s"));

		assert_eq!(Some(String::from("sea")), t.longest_key_of_prefix("sea"));
		assert_eq!(
			Some(String::from("sea")),
			t.longest_key_of_prefix("seafood")
		);
		assert_eq!(
			Some(String::from("seashells")),
			t.longest_key_of_prefix("seashellsabc")
		);
	}
}
